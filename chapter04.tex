...
\begin{table}[t]
	\small{
		\begin{center}
			\caption{Experimental items: each basic-level context had two potential targets from an either saliently small or saliently big subordinate category within the basic-level class. Each context had a corresponding context cover story, and the referent had an additional visually salient feature \pt{column widths to be fixed}}
			\label{stims:e4}
			\vskip 0.12in
			\fontsize{10}{11}\selectfont
			\begin{tabularx}{\textwidth}{XXXXX}
				...
				Dogs & Chihuahua & Doberman & ... are at an animal training ground. & service-animal\\
				Birds & Hummingbird & Eagle & You visit your friend who works at an animal shelter. & rescue  \\
				Flowers & Dandelion & Sunflower & ... are at their garden. & gift\\
				Trees & Bonsai & Redwood & ... walk to their cabin in a park for the first time. You want to memorize the path. & landmark\\
				\hline     
			\end{tabularx}
		\end{center}
	}
