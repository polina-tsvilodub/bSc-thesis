...
\end{equation*} 
where the pragmatic listener then reasons about the value of $\phi$. To compute the utility for one goal, $L_0$ is marginalized over the other aspect of the state of the world (equivalently to the QUD-based Model 2) \pt{formula}.
